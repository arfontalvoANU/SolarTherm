...
model SingleTankROM "TES Component model of a single thermocline tank with spherical fillers"
  ...
  //Initialize Tank
  SolarTherm.Models.Storage.Thermocline.Spheres.SectionROM Tank_A(
