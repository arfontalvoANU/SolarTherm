...
model SingleTank_Final "TES Component model of a single thermocline tank with spherical fillers"
  ...
  //Initialize Tank
  SolarTherm.Models.Storage.Thermocline.Spheres.Section_Final Tank_A(
...
annotation(
    ...
    Ellipse(origin = {-10, -54}, fillColor = {40, 50, 200}, fillPattern = FillPattern.Sphere, extent = {{-4, 4}, {6, -6}}),
    Ellipse(origin = {-20, -54}, fillColor = {40, 50, 200}, fillPattern = FillPattern.Sphere, extent = {{-4, 4}, {6, -6}}),
    Text(origin = {-60, 31}, extent = {{-16, 7}, {6, -3}}, textString = "T_amb"), 
    Text(origin = {-60, -10}, extent = {{-16, 10}, {8, -6}}, textString = "p_amb"), 
    Text(origin = {-60, -67}, extent = {{-26, 5}, {28, -3}}, textString = "h_bot_outlet"), 
    Text(origin = {66, -37}, extent = {{-18, 5}, {42, -25}}, textString = "T_bot_measured"), 
    Text(origin = {69, 74}, extent = {{-15, 4}, {41, -20}}, textString = "T_top_measured"), 
    Text(origin = {22, 84}, extent = {{-12, 4}, {24, -12}}, textString = "fluid_a"), 
    Text(origin = {24, -76}, extent = {{-12, 4}, {26, -12}}, textString = "fluid_b"), 
    Text(origin = {60, 51.5}, extent = {{-6, 2.5}, {14, -9.5}}, textString = "T_95%"), 
    Text(origin = {54, -24.5}, extent = {{-6, 2.5}, {16, -11.5}}, textString = "T_05%"), 
    Text(origin = {62, 33}, extent = {{-8, 3}, {12, -7}}, textString = "Level"), 
    Text(origin = {-60, 67}, extent = {{-28, 5}, {28, -3}}, textString = "h_top_outlet"), 
    Text(origin = {118, -128}, lineColor = {0, 0, 255}, extent = {{-150, 150}, {150, 110}}, textString = "%name", fontSize = 10)}, 
