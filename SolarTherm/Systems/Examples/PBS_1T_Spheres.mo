...
model PBS_1T_Spheres "Packed-bed storage with air and spheres of MgO"
    ...
    parameter SI.TemperatureDifference T_tol_PB = 0.1 "Power block Temperature Tolerance (K)";
    ...
    //Storage Model
    SolarTherm.Models.Storage.Thermocline.Spheres.SingleTank_Final thermocline_Tank(
...
//Connectors
    ...
    Documentation(info =
        ...
        <body>
          ...
          <p>Thermal energy storage tank with:</p>
          <ul>
            <li><b>Fluid:</b> Liquid Sodium</li>
            <li><b>Filler:</b> Horizontal Cylinder MgO</li>
          </ul>
