...
partial model Electric_Heater
  ...
  Modelica.Blocks.Interfaces.RealInput P_supply "Supplied electrical power" annotation (Placement(
        ...
        origin={2, 102},extent={{12, -12}, {-12, 12}},
        rotation= 90)));
  ...
  annotation(
    Icon(coordinateSystem(initialScale = 0.1), graphics = {Rectangle(lineColor = {200, 200, 200}, fillColor = {248, 248, 248}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -100}, {100, 100}}, radius = 25), Ellipse(origin = {1, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-50, 50}, {50, -50}}), Polygon(origin = {1, -3}, fillColor = {252, 233, 79}, fillPattern = FillPattern.Solid, points = {{1, 49}, {-31, -5}, {5, -1}, {-1, -43}, {27, 17}, {-7, 11}, {1, 49}}), Line(origin = {-75, 2}, points = {{25, 0}, {-25, 0}}), Line(origin = {75.0846, 0.57827}, points = {{25, 0}, {-25, 0}})}));
