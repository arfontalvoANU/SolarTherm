...
package MgO_constant "MgO constant cp and density, variable thermal conductivity"
  ...
  constant SI.SpecificHeatCapacity cp_1 = 1030 "Specific heat capacity of solid (J/kgK)";
  constant SI.Density rho_1 = 3565 "Density of solid (kg/m3)";
