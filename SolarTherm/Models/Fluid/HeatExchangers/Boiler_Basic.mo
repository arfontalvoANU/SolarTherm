...
import Modelica.SIunits.Conversions.*;
  ...
  Modelica.Blocks.Interfaces.RealOutput h_out_signal "outlet specific enthalpy" annotation (Placement(visible = true, transformation(origin = {-80, -72}, extent = {{20, -20}, {-20, 20}}, rotation = 0), iconTransformation(origin = {-86, 72}, extent = {{-8, -8}, {8, 8}}, rotation = 90))) ;
...
equation
  ...
  annotation(
    Icon(graphics = {Text(origin = {0, -6}, lineColor = {0, 0, 255}, extent = {{-149, -114}, {151, -154}}, textString = "%name"), Rectangle(fillColor = {135, 135, 135}, fillPattern = FillPattern.Backward, extent = {{-100, 64}, {100, -64}}), Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -44}, {100, 44}}), Rectangle(fillColor = {0, 127, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, -44}, {100, 44}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{18, 0}, {48, -29}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-1, 29}, {29, 0}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{43, 31}, {73, 2}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-31, 1}, {-1, -28}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{50, 15}, {80, -14}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-72, 25}, {-42, -4}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{71, -11}, {101, -40}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{72, 28}, {102, -1}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{71, 40}, {101, 11}}), Line(points = {{0, -64}, {0, -100}}, color = {0, 127, 255}), Line(origin = {-40, 0}, points = {{40, 100}, {40, 64}}, color = {0, 127, 255}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{58, -11}, {88, -40}}), Ellipse(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{71, 1}, {101, -28}})}, coordinateSystem(initialScale = 0.1)));
end Boiler_Basic;